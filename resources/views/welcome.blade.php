...
<body>
    ...
    <div class="container text-center my-4"> <!-- Añadimos un contenedor y centramos el contenido -->
        <a href="{{ route('login') }}" class="btn btn-primary btn-lg">Iniciar sesión</a> <!-- Usamos un enlace simple, más común para navegar -->
    </div>
